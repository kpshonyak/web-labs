...
const getFilmsFromStorage = () => {
    let films = JSON.parse(localStorage.getItem(filmsKey));
...
const displayMovies = (moviesToDisplay) => {
    ...
    moviesToDisplay.forEach((film, index) => { 
        ...
        movieCard.innerHTML = `
            ...
            <hr>
            <a href="edit.html?index=${index}" class="edit-btn">Редагувати</a> 
        `;
...
const handleSort = (event) => {
    ...
    let sortedFilms = [...getFilmsFromStorage()]; 
